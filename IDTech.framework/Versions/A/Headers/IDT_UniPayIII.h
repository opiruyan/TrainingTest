...
@protocol IDT_UniPayIII_Delegate <NSObject>
@optional
 ...
 */
@interface IDT_UniPayIII : NSObject<IDT_Device_Delegate>{
    id<IDT_UniPayIII_Delegate> delegate;
}

@property(strong) id<IDT_UniPayIII_Delegate> delegate;  //!<- Reference to IDT_UniPayIII_Delegate.
 ...
 *
 ...
 @return  Instance of IDT_UniPayIII
 */
